...
Page({
  data: {
    ...
    hotSpecs: [
      { id: 'yicun', name: '一寸', size: '25×35mm', icon: 'person', iconColor: '#2d7cf2', thumbBg: '#eef3ff' },
      { id: 'ercun', name: '二寸', size: '35×49mm', icon: 'person2', iconColor: '#f6a52c', thumbBg: '#fff4e7' },
      { id: 'dayicun', name: '大一寸', size: '33×48mm', icon: 'person3', iconColor: '#27b673', thumbBg: '#ecfbf2' },
      { id: 'xiaoyicun', name: '小一寸', size: '22×32mm', icon: 'person4', iconColor: '#f6a52c', thumbBg: '#fff7df' },
      { id: 'jianli', name: '简历照片', size: '25×35mm', icon: 'doc', iconColor: '#f2a33a', thumbBg: '#edf5ff' }
    ],
    moreTools: [
