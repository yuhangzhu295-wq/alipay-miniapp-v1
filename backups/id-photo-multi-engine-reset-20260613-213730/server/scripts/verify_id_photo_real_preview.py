...
REPORT_DIR = ROOT / "reports" / "id-photo-real-preview-debug"
...
def clear_runtime_cache() -> dict[str, Any]:
    ...
    for registry in ("asset_registry.json", "user_photo_registry.json"):
...
def residue_check(image_path: Path, bg_hex: str, face_box: dict[str, Any]) -> dict[str, Any]:
    ...
    passed = pixels <= 95 and max_area <= 38 and components <= 6
    return {
