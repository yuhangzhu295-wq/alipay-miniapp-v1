...
def get_headshot_crop_box(image_size, face_box):
    ...
    left = face_center_x - fw * 1.50
    right = face_center_x + fw * 1.50
    top = fy - fh * 0.62
    bottom = fy + fh * 2.42
...
def compose_headshot(cutout, quality, background, target_size=(413, 579), face_height_ratio=0.34, composition="head_shoulder"):
    """
